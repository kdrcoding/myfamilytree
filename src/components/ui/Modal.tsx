  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={`max-h-[92vh] w-full ${SIZES[size]} animate-modal-in overflow-y-auto rounded-t-2xl bg-white p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] text-stone-900 shadow-2xl outline-none sm:rounded-2xl sm:pb-5 dark:bg-stone-900 dark:text-stone-100 dark:ring-1 dark:ring-stone-700`}
      >
