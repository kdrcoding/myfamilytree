...
export const en = {
  ...
  'settings.backupDownloadLatest': 'Download latest backup',
  'settings.backupDownloaded': 'Backup file downloaded.',
  'settings.backupMonthlyNudge':
    'It has been a month (or longer) since you downloaded a backup — grab the latest copy for safekeeping.',
  'settings.backupLastDownload': 'Last download on this device: {when}',
  ...
  'gate.wrongOwner': 'Wrong owner password.',
  'gate.useOwnerLogin': 'That is the owner password — open Owner / Kadir login instead.',
  'gate.sessionFailed':
    'Password looks right, but signing in failed. Check your connection and try again — if it keeps failing, ask Kadir.',
  'gate.enter': 'Please enter the password.',
  'gate.yourName': 'Your name',
  'gate.nameHint': 'So the family knows who made each change.',
  'gate.nameKnownHint': 'Continuing as this name on this device.',
  'gate.changeName': 'Use another name',
  ...
  'gate.continueAs': 'Continue as {name}',
  'gate.namePlaceholder': 'e.g. Aziza',
  'gate.ownerToggle': 'Owner / Kadir login',
  'gate.ownerTitle': 'Owner login',
  'gate.ownerIntro':
    'Separate from family login. Owner password only — for delete, settings, and other owner tools.',
  'gate.ownerPassword': 'Owner password',
  'gate.ownerBtn': 'Sign in as owner',
  'gate.backToFamily': 'Back to family login',
  'log.by': 'by',
  ...
  'home.intro':
    'Explore every branch — the people, places, and stories that connect us.',
  'home.introEasy':
    'Find someone by name, or open the family tree.',
  'home.introMobile': 'Search a name, or tap a button below.',
  'home.searchTitle': 'Find someone',
  'home.searchPlaceholder': 'Type a name…',
  'home.summaryLabel': 'Family summary',
  'home.related': 'How are we related?',
  'home.explore': 'Open family tree',
  'home.browse': 'Browse members',
  'home.addSelf': 'Add yourself',
  ...
  'home.celebrationsTitle': 'Birthdays, anniversaries & traditions',
  'home.whosNextTitle': 'Who’s next',
  'home.whosNextIntro': 'The next three birthdays in the family.',
  'home.datesProgressLabel': 'Missing birth dates',
  'home.datesProgress': '{left} dates left · {filled} filled this week',
  'home.datesProgressDone': 'All dates filled · {filled} added this week',
  'home.datesProgressCta': 'Fill dates',
  'home.celebrationBirthday': 'Birthday',
  'home.celebrationAnniversary': 'Wedding anniversary',
  'home.celebrationTradition': 'Family tradition',
  'home.annivTitle': 'Wedding anniversaries',
  'home.annivToastOne': 'Happy anniversary — {names}!',
  'home.annivToastMany': '{n} wedding anniversaries today!',
  ...
  // Family traditions (Navruz, Eid, reunions — never names people)
  'tradition.navruz': 'Navruz',
  'tradition.eidFitr': 'Eid al-Fitr',
  'tradition.eidAdha': 'Eid al-Adha',
  'tradition.newYear': 'New Year',
  'tradition.reunionFallback': 'Family reunion',
  'tradition.wishNavruz': 'Happy Navruz!',
  'tradition.wishEidFitr': 'Eid Mubarak!',
  'tradition.wishEidAdha': 'Eid Mubarak!',
  'tradition.wishNewYear': 'Happy New Year!',
  'tradition.wishReunion': 'Happy {title}!',
  'tradition.popupKicker': 'Family tradition',
  'tradition.popupBody':
    'A joyful day for our family — share warm wishes with everyone.',
  'tradition.popupDismiss': 'Celebrate',
  'tradition.settingsTitle': 'Family traditions',
  'tradition.settingsIntro':
    'Navruz, Eid, New Year, and your own reunions. On the day, the home page greets everyone with a happy message.',
  'tradition.addReunion': 'Add a reunion',
  'tradition.titlePlaceholder': 'e.g. Summer gathering',
  'tradition.add': 'Add',
  'tradition.addHint': 'One-off dates for get-togethers. Built-in holidays repeat every year.',
  'tradition.remove': 'Remove reunion',
  'tradition.saved': 'Traditions saved.',
  'tradition.saveFailed': 'Could not save traditions — try again.',
  'tradition.invalid': 'Enter a title and a valid date.',
  'home.prevBirthday': 'Previous birthday',
  'home.nextBirthday': 'Next birthday',
  'home.pathsTitle': 'Walk through the family',
  'home.pathsIntro': 'Each door opens a different view of the same people.',
  'home.pathTreeHint': 'Every generation on one living tree.',
  'home.pathMembersHint': 'Names, photos, and who belongs with whom.',
  'home.pathMapHint': 'Where the family lives today.',
  'home.pathTimelineHint': 'Births, weddings, and memories in order.',
  'home.pathRelatedHint': 'How two people are related, in plain words.',
  'home.facesTitle': 'Faces of the family',
  'home.facesMore': '{n} more in the tree',
  ...
  'couple.weddingDay': 'They celebrate every year on {day}',
  'couple.weddingDayKnown': 'Wedding day is recorded — add the full date for anniversary reminders.',
  'couple.noDate': 'Wedding date not recorded yet',
  'couple.nextAnniversary': 'Next anniversary',
  'couple.addDateHint': 'Ask someone with edit access to add the wedding details.',
  'couple.place': 'Wedding place',
  'couple.placePlaceholder': 'City, venue, or country',
  'couple.notes': 'Notes',
  'couple.notesPlaceholder': 'Anything the family should remember about this wedding',
  'couple.dateHint': 'Year is enough to record — add month and day so it appears with birthdays on Home.',
  'couple.invalidDate': 'That date does not look right. Use year, or year–month–day.',
  'couple.addDetails': 'Add wedding details',
  'couple.editDetails': 'Edit wedding details',
  'couple.saved': 'Wedding details saved',
  'couple.markDivorced': 'Mark as divorced',
  'couple.markMarried': 'Mark as still married',
  'couple.markedDivorced': 'Marked as divorced',
  'couple.markedMarried': 'Marked as married again',
  'couple.divorceConfirmTitle': 'Mark as divorced?',
  'couple.divorceConfirmMsg':
    'This changes how the couple appears on the tree (dashed line instead of wedding rings). You can undo it later.',
  'couple.divorceConfirmBtn': 'Mark divorced',
  'couple.remarryConfirmTitle': 'Mark as married again?',
  'couple.remarryConfirmMsg': 'Wedding rings will show on the tree again for this couple.',
  ...
  'tree.openDetailsComplete': 'Open details for {name} — profile looking complete',
  'tree.profileComplete': 'Profile looking complete',
  'tree.print': 'Print',
  ...
  'telegram.intro':
    'Post a warm birthday wish in your family Telegram group (Uzbek) — with a card, a no-password page, and an in-group “Men tabriklayman” button so people can cheer without leaving the chat.',
  ...
  'telegram.previewReminder': 'Preview weekend reminder',
  'telegram.sendUpcomingNow': 'Send weekend reminder now',
  'telegram.previewTitle': 'Weekend reminder preview',
  'telegram.previewIntro': 'Exact text the bot will post (photo caption + list). Nothing is sent until you confirm.',
  'telegram.previewCaption': 'Photo caption (next up)',
  'telegram.previewList': 'Group list message',
  'telegram.previewClose': 'Close',
  'telegram.previewFailed': 'Could not build the reminder preview.',
  'telegram.sendUpcomingOk': 'Sent weekend reminder ({n} people{photo}).',
  'telegram.sendUpcomingPhotoYes': ', with next-up photo',
  'telegram.sendUpcomingPhotoNo': '',
  'telegram.sendUpcomingFailed': 'Could not send the weekend reminder.',
  'telegram.filledThisWeek': '{n} filled this week',
  ...
  'telegram.nextInDays': 'in {n} days',
  'telegram.nextTurns': 'turns {age}',
  'telegram.openMembers': 'Open Members',
  'telegram.openMissingDates': 'Fill missing birthdays',
  'telegram.healthTitle': 'Bot health (owner)',
  'telegram.healthLastOk': 'Last successful run: {when} ({hours}h ago).',
  'telegram.healthNever': 'No successful cron run recorded yet.',
  'telegram.healthLastError': 'Last error: {error}',
  'telegram.healthStale': 'No successful run in 26+ hours — check GitHub Actions and Edge logs.',
  'telegram.healthOk': 'OK',
  'telegram.healthFail': 'Fail',
  'telegram.healthEmpty': 'No run log yet — wait for the next hourly cron.',
  ...
  'bday.cheersEmpty':
    'No names yet — cheer below, or tap “Men tabriklayman” on the Telegram birthday post.',
  'bday.cheersYesterday': 'Who sent congratulations',
  'bday.cheerTitle': 'I congratulate',
  'bday.cheerHint': 'Your name appears on this page and in the family Telegram group.',
  'bday.cheerKnownHint': 'Using the name already on this device — tap once to congratulate.',
  'bday.cheerAs': 'As {name}',
  'bday.cheerChangeName': 'Use another name',
  'bday.cheerName': 'Your name',
  'bday.cheerNamePlaceholder': 'Your first name',
  'bday.cheerSubmit': 'Congratulate',
  'bday.cheerOk': 'Thank you — your congratulations were added.',
  ...
  'dates.intro':
    'Open this page from the family’s Telegram link. Type your name once, tap a person, and save their birth date here — no password while the link is valid (about 7 days).',
  'dates.loading': 'Loading the list…',
  'dates.count': '{n} people still need a date',
  'dates.fillAll': 'Open the list to fill dates',
  'dates.fillHint': 'Tap a name, pick the date, save. Your name above is only so the family knows who filled it in.',
  'dates.yourName': 'Your name',
  'dates.yourNamePlaceholder': 'e.g. Aziza',
  'dates.yourNameHint': 'Needed once before you save a date.',
  'dates.yourNameKnownHint': 'Using the name already on this device.',
  'dates.changeName': 'Use another name',
  'dates.nameRequired': 'Enter your name (at least 2 letters).',
  'dates.birthDateLabel': 'Birth date',
  'dates.saveDate': 'Save date',
  'dates.dateInvalid': 'Pick a full, real birth date.',
  'dates.saved': 'Saved {name}’s birth date.',
  'dates.saveFailed': 'Could not save — try again.',
  ...
  'dates.badLinkTitle': 'This link looks broken',
  'dates.badLinkBody':
    'The code in the link is incomplete or got cut when it was copied. Open the Fill dates button in Telegram again, or ask for a fresh link.',
  ...
  'dates.footer': 'Signed Telegram links only — valid about 7 days. Filling asks for your name, not a password.',
  ...
  'form.duplicateTitle': 'Possible duplicate person',
  ...
  'install.title': 'Add Oq-Ariq to your phone',
  'install.body': 'Put a home-screen icon so elders can open the family site in one tap.',
  'install.bodyIos': 'Tap Share, then “Add to Home Screen” — the family site opens like an app.',
...
export const uz: Record<TKey, string> = {
  ...
  'settings.backupDownloadLatest': 'Eng so‘nggi zaxirani yuklab olish',
  'settings.backupDownloaded': 'Zaxira fayli yuklab olindi.',
  'settings.backupMonthlyNudge':
    'Zaxirani yuklab olganingizga bir oy yoki undan ko‘p bo‘ldi — xavfsizlik uchun eng so‘nggisini oling.',
  'settings.backupLastDownload': 'Shu qurilmada oxirgi yuklab olish: {when}',
  ...
  'gate.wrongOwner': "Egasi paroli noto'g'ri.",
  'gate.useOwnerLogin': 'Bu egasi paroli — “Egasi / Kadir” kirishini oching.',
  'gate.sessionFailed':
    'Parol to‘g‘ri ko‘rinadi, lekin kirish muvaffaqiyatsiz. Internetni tekshirib qayta urinib ko‘ring — davom etsa, Kadirdan so‘rang.',
  ...
  'gate.nameKnownHint': 'Bu qurilmadagi ismingiz bilan davom etasiz.',
  'gate.changeName': 'Boshqa ism',
  ...
  'gate.continueAs': '{name} sifatida davom etish',
  'gate.namePlaceholder': 'masalan, Aziza',
  'gate.ownerToggle': 'Egasi / Kadir kirishi',
  'gate.ownerTitle': 'Egasi kirishi',
  'gate.ownerIntro':
    "Oila kirishidan alohida. Faqat egasi paroli — o'chirish, sozlamalar va egasi vositalari uchun.",
  'gate.ownerPassword': 'Egasi paroli',
  'gate.ownerBtn': 'Egasi sifatida kirish',
  'gate.backToFamily': 'Oila kirishiga qaytish',
  'log.by': '·',
  ...
  'home.intro':
    "Har bir shox — insonlarimiz, joylarimiz va bizni bog'lab turgan hikoyalar.",
  'home.introEasy':
    "Ism bo'yicha qidiring yoki shajarani oching.",
  ...
  'home.explore': "Shajarani ochish",
  'home.browse': "A'zolarni ko'rish",
  'home.addSelf': "O'zingizni qo'shing",
  ...
  'home.celebrationsTitle': 'Tug‘ilgan kunlar, yubileylar va an’analar',
  'home.whosNextTitle': 'Kim keyingi',
  'home.whosNextIntro': 'Oiladagi keyingi uchta tug‘ilgan kun.',
  'home.datesProgressLabel': 'Yetishmayotgan sanalar',
  'home.datesProgress': '{left} ta sana qoldi · shu hafta {filled} ta to‘ldirildi',
  'home.datesProgressDone': 'Barcha sanalar to‘liq · shu hafta {filled} ta qo‘shildi',
  'home.datesProgressCta': 'Sanalarni to‘ldirish',
  'home.celebrationBirthday': 'Tug‘ilgan kun',
  'home.celebrationAnniversary': 'Nikoh yubileyi',
  'home.celebrationTradition': 'Oila an’anasi',
  'home.annivTitle': "Nikoh to'ylari",
  'home.annivToastOne': 'Yubiley bilan — {names}!',
  'home.annivToastMany': 'Bugun {n} ta nikoh yubileyi!',
  ...
  'home.bdayPopupOpen': 'Bayramni ochish',
  'home.bdayPopupSeeAll': 'Bayramlarni ko‘rish',
  'home.bdayPopupDismiss': 'Tushundim',
  'home.todaySpotlightTitle': 'Bugun tabriklaymiz',
  'home.todaySpotlightWish': 'Tug‘ilgan kunini tabriklang',
  'home.openCelebration': 'To‘liq bayram sahifasini ochish',
  'home.todayBirthdayCount': 'Bugun {n} ta tug‘ilgan kun',

  'tradition.navruz': 'Navro‘z',
  'tradition.eidFitr': 'Ramazon hayiti',
  'tradition.eidAdha': 'Qurbon hayiti',
  'tradition.newYear': 'Yangi yil',
  'tradition.reunionFallback': 'Oila uchrashuvi',
  'tradition.wishNavruz': 'Navro‘z muborak!',
  'tradition.wishEidFitr': 'Hayit muborak!',
  'tradition.wishEidAdha': 'Hayit muborak!',
  'tradition.wishNewYear': 'Yangi yilingiz bilan!',
  'tradition.wishReunion': '{title} muborak!',
  'tradition.popupKicker': 'Oila an’anasi',
  'tradition.popupBody':
    'Oilamiz uchun quvonchli kun — hammaga iliq tilaklar ayting.',
  'tradition.popupDismiss': 'Bayram qilamiz',
  'tradition.settingsTitle': 'Oila an’analari',
  'tradition.settingsIntro':
    'Navro‘z, Hayit, Yangi yil va o‘zingizning uchrashuvlaringiz. Shu kuni bosh sahifa oilani baxtli xabar bilan kutib oladi.',
  'tradition.addReunion': 'Uchrashuv qo‘shish',
  'tradition.titlePlaceholder': 'masalan, Yozgi yig‘in',
  'tradition.add': 'Qo‘shish',
  'tradition.addHint': 'Bir martalik uchrashuv sanalari. Asosiy bayramlar har yili takrorlanadi.',
  'tradition.remove': 'Uchrashuvni o‘chirish',
  'tradition.saved': 'An’analar saqlandi.',
  'tradition.saveFailed': 'An’analarni saqlab bo‘lmadi — qayta urinib ko‘ring.',
  'tradition.invalid': 'Sarlavha va to‘g‘ri sanani kiriting.',

  'home.prevBirthday': 'Oldingi tug‘ilgan kun',
  'home.nextBirthday': 'Keyingi tug‘ilgan kun',
  'home.pathsTitle': 'Oilani aylanib chiqing',
  'home.pathsIntro': 'Har bir eshik — o‘sha odamlarni boshqacha ko‘rish.',
  'home.pathTreeHint': 'Har avlod bitta tirik shajarada.',
  'home.pathMembersHint': 'Ismlar, suratlar va kim kimniki.',
  'home.pathMapHint': 'Oila bugun qayerda yashaydi.',
  'home.pathTimelineHint': 'Tug‘ilish, to‘y va xotiralar tartibda.',
  'home.pathRelatedHint': 'Ikki odam qanday qarindosh — oddiy so‘zlar bilan.',
  'home.facesTitle': 'Oila yuzlari',
  'home.facesMore': 'Shajarada yana {n} kishi',
  ...
  'tree.listView': "Odamlar ro'yxati",
  ...
  'couple.weddingDay': 'Har yili {day} kuni nishonlanadi',
  'couple.weddingDayKnown': 'Nikoh kuni yozilgan — yubiley eslatmalari uchun to‘liq sanani qo‘shing.',
  'couple.noDate': 'Nikoh sanasi hali yozilmagan',
  'couple.nextAnniversary': 'Keyingi yubiley',
  'couple.addDateHint': 'Nikoh ma’lumotlarini tahrirlash huquqi bor odamdan so‘rang.',
  'couple.place': 'Nikoh joyi',
  'couple.placePlaceholder': 'Shahar, joy yoki mamlakat',
  'couple.notes': 'Izoh',
  'couple.notesPlaceholder': 'Oilaga esda qolishi kerak bo‘lgan narsa',
  'couple.dateHint': 'Yil yetarli — Home’da tug‘ilgan kunlar yonida chiqishi uchun oy va kunni ham qo‘shing.',
  'couple.invalidDate': 'Sana noto‘g‘ri ko‘rinadi. Yil yoki yil–oy–kun kiriting.',
  'couple.addDetails': 'Nikoh ma’lumotlarini qo‘shish',
  'couple.editDetails': 'Nikoh ma’lumotlarini tahrirlash',
  'couple.saved': 'Nikoh ma’lumotlari saqlandi',
  'couple.markDivorced': 'Ajrashgan deb belgilash',
  'couple.markMarried': 'Yana turmushda deb belgilash',
  'couple.markedDivorced': 'Ajrashgan deb belgilandi',
  'couple.markedMarried': 'Yana turmushda deb belgilandi',
  'couple.divorceConfirmTitle': 'Ajrashgan deb belgilansinmi?',
  'couple.divorceConfirmMsg':
    'Daraxtada juftlik chiziqlari o‘zgaradi (uzuklar o‘rniga punktir). Keyinroq bekor qilish mumkin.',
  'couple.divorceConfirmBtn': 'Ajrashgan deb belgilash',
  'couple.remarryConfirmTitle': 'Yana turmushda deb belgilansinmi?',
  'couple.remarryConfirmMsg': 'Bu juftlik uchun daraxtada yana uzuklar ko‘rinadi.',
  ...
  'tree.openDetailsComplete': '{name} haqida batafsil — ma’lumotlar to‘liq ko‘rinadi',
  'tree.profileComplete': 'Ma’lumotlar to‘liq ko‘rinadi',
  ...
  'telegram.intro':
    'Oila Telegram guruhiga o‘zbekcha issiq tilak — otkritka, parolsiz bayram sahifasi va guruhdagi “Men tabriklayman” tugmasi (chatdan chiqmasdan).',
  'telegram.setupNeeded':
  ...
  'telegram.previewReminder': 'Hafta oxiri eslatmasini ko‘rish',
  'telegram.sendUpcomingNow': 'Hafta oxiri eslatmasini hozir yuborish',
  'telegram.previewTitle': 'Hafta oxiri eslatmasi — ko‘rib chiqish',
  'telegram.previewIntro':
    'Bot yuboradigan aniq matn (rasm izohi + ro‘yxat). Tasdiqlamaguncha hech narsa yuborilmaydi.',
  'telegram.previewCaption': 'Rasm izohi (keyingi kishi)',
  'telegram.previewList': 'Guruhdagi ro‘yxat xabari',
  'telegram.previewClose': 'Yopish',
  'telegram.previewFailed': 'Eslatma matnini yasab bo‘lmadi.',
  'telegram.sendUpcomingOk': 'Hafta oxiri eslatmasi yuborildi ({n} kishi{photo}).',
  'telegram.sendUpcomingPhotoYes': ', keyingi kishi rasmi bilan',
  'telegram.sendUpcomingPhotoNo': '',
  'telegram.sendUpcomingFailed': 'Hafta oxiri eslatmasini yuborib bo‘lmadi.',
  'telegram.filledThisWeek': 'shu hafta {n} ta to‘ldirildi',
  ...
  'telegram.coverageOk': 'To‘liq sanasi bor barcha oila a’zolari tabriklanishi mumkin.',
  ...
  'telegram.nextInDays': '{n} kundan keyin',
  'telegram.nextTurns': '{age} yoshga to‘ladi',
  'telegram.openMembers': 'A’zolarni ochish',
  'telegram.openMissingDates': 'Sanalarni to‘ldirish',
  'telegram.healthTitle': 'Bot sog‘lig‘i (egasi)',
  'telegram.healthLastOk': 'Oxirgi muvaffaqiyatli ish: {when} ({hours} soat oldin).',
  'telegram.healthNever': 'Hali muvaffaqiyatli cron ishi yoqilmagan.',
  'telegram.healthLastError': 'Oxirgi xato: {error}',
  'telegram.healthStale': '26+ soatdan beri muvaffaqiyatli ish yo‘q — GitHub Actions va Edge loglarini tekshiring.',
  'telegram.healthOk': 'OK',
  'telegram.healthFail': 'Xato',
  'telegram.healthEmpty': 'Jurnal hali bo‘sh — keyingi soatlik cronni kuting.',
  ...
  'bday.wish':
    'Butun oila bugun sizni tabriklaydi. Yoshligingiz sog‘liq, kulgi va muhabbatga to‘la bo‘lsin.',
  'bday.cheersTitle': 'Sizni tabriklayotganlar ({n})',
  'bday.cheersEmptyTitle': 'Oila tabriklari',
  'bday.cheersEmpty':
    'Hali ism yo‘q — pastda tabriklang yoki Telegramdagi “Men tabriklayman” ni bosing.',
  'bday.cheersYesterday': 'Oila bilan tabriklashganlar',
  'bday.cheerTitle': 'Men tabriklayman',
  'bday.cheerHint': 'Ismingiz shu sahifada va oila Telegram guruhida ko‘rinadi.',
  'bday.cheerKnownHint': 'Bu qurilmadagi ismingiz ishlatiladi — bir marta bosing.',
  'bday.cheerAs': '{name} sifatida',
  'bday.cheerChangeName': 'Boshqa ism',
  'bday.cheerName': 'Ismingiz',
  'bday.cheerNamePlaceholder': 'Ismingiz',
  'bday.cheerSubmit': 'Tabriklash',
  'bday.cheerOk': 'Rahmat — tabrigingiz qo‘shildi.',
  ...
  'dates.intro':
    'Bu sahifani oila Telegram havolasidan oching. Bir marta ismingizni yozing, odamni bosing va tug‘ilgan kunini shu yerda saqlang — havola taxminan 7 kun, parol kerak emas.',
  'dates.loading': 'Ro‘yxat yuklanmoqda…',
  'dates.count': 'Hali {n} kishida sana yo‘q',
  'dates.fillAll': 'Sanalarni to‘ldirish uchun ochish',
  'dates.fillHint': 'Ismni bosing, sanani tanlang, saqlang. Yuqoridagi ism faqat kim to‘ldirganini bilish uchun.',
  'dates.yourName': 'Ismingiz',
  'dates.yourNamePlaceholder': 'masalan, Aziza',
  'dates.yourNameHint': 'Sanani saqlashdan oldin bir marta kerak.',
  'dates.yourNameKnownHint': 'Bu qurilmadagi ismingiz ishlatiladi.',
  'dates.changeName': 'Boshqa ism',
  'dates.nameRequired': 'Ismingizni yozing (kamida 2 harf).',
  'dates.birthDateLabel': 'Tug‘ilgan sana',
  'dates.saveDate': 'Sanani saqlash',
  'dates.dateInvalid': 'To‘liq va to‘g‘ri tug‘ilgan sanani tanlang.',
  'dates.saved': '{name}ning tug‘ilgan sanasi saqlandi.',
  'dates.saveFailed': 'Saqlab bo‘lmadi — qayta urinib ko‘ring.',
  ...
  'dates.badLinkTitle': 'Bu havola buzilgan ko‘rinadi',
  'dates.badLinkBody':
    'Havodagi kod to‘liq emas yoki nusxa olganda kesilib qolgan. Telegramdagi “Sanalarni to‘ldirish” tugmasini qayta bosing yoki yangi havola so‘rang.',
  ...
  'dates.footer': 'Faqat imzolangan Telegram havolalari — taxminan 7 kun. To‘ldirishda ism so‘raladi, parol emas.',
  ...
  'form.duplicateTitle': 'Bu odam allaqachon mavjud bo‘lishi mumkin',
  ...
  'install.title': 'Oq-Ariqni telefoningizga qo‘shing',
  'install.body': 'Bosh ekranga belgi qo‘ying — kattalar oila saytini bir bosishda ochadi.',
  'install.bodyIos': 'Ulashish → “Bosh ekranga qo‘shish” — sayt ilova kabi ochiladi.',
  'install.btn': 'Bosh ekranga qo‘shish',
  'install.iosHint': 'Ulashish → Bosh ekranga qo‘shish',
  'install.dismiss': 'Hozir emas',
