...
export const en = {
  ...
  'settings.photosEmbedded': '{n} photos (~{mb} MB) are still stored inside the database.',
  ...
  'settings.photosPartial': '{n} photos could not be moved. Try again later.',
  ...
  'settings.countriesCount': '{n} members have a country spelling that can be unified.',
