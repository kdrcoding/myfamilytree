...
export const en = {
  ...
  'couple.addDateHint': 'Owners can add the wedding date when editing either person.',
...
export const uz: Record<TKey, string> = {
  ...
  'couple.addDateHint': 'Egasi har qaysi odamni tahrirlab nikoh sanasini qo‘shishi mumkin.',
